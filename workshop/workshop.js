 'use strict';
  function AppViewModel(){
        ...
        self.newskills=ko.observableArray(['HTML','CSS','Java','NodeJS','Angular js','Knockout js','Javascript','JQuery','C','C++','Python','MATLAB','React Js','Backbone']);
